...
class ProjectSettings(BaseModel):
    ...
    Attributes:
        ...
        cop_direct(float): Value of the COP.
    """
    time_horizon: int
    start_date: datetime
    discount_rate: float
...
class TESParams(BaseModel):
    tes_capacity: float
    tes_initial_soc: float
    tes_max_charge_rate: float
    tes_max_discharge_rate: float
    tes_storage_efficiency: float
    tes_cop: float
    tes_q_per_kg: float
    tes_specific_investment_cost: float
    tes_specific_om_cost: float
    tes_lifetime: int
    tes_compressor_specific_investment_cost: float
...
class CompressorParams(BaseModel):
    compressor_specific_investment_cost: float
    compressor_specific_om_cost: float
    compressor_lifetime: int
